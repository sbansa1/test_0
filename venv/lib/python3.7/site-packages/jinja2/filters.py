...
def do_join(eval_ctx, value, d=u'', attribute=None):
    ...
    .. sourcecode:: jinja
        ...
        {{ user_service|join(', ', attribute='username') }}
...
def do_groupby(environment, value, attribute):
    ...
    group all user_service by genders you can do something like the following
    snippet:
...
def do_map(*args, **kwargs):
    ...
    of user_service but you are only interested in a list of usernames:

    .. sourcecode:: jinja

        Users on this page: {{ user_service|map(attribute='username')|join(', ') }}
...
def do_selectattr(*args, **kwargs):
    ...
    .. sourcecode:: jinja
        ...
        {{ user_service|selectattr("is_active") }}
        {{ user_service|selectattr("email", "none") }}
...
def do_rejectattr(*args, **kwargs):
    ...
    .. sourcecode:: jinja
        ...
        {{ user_service|rejectattr("is_active") }}
        {{ user_service|rejectattr("email", "none") }}
