    ...
    def values(self, *args, **kwargs):
        ...
        :param \**kwargs: key value pairs representing the string key
          ...
          VALUES or SET clause::
                ...
                user_service.insert().values(name="some name")

                user_service.update().where(user_service.c.id==5).values(name="some name")
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         the kwargs form::
            ...
            user_service.update().values({"name": "some new name"})
         ...
         table is also accepted::
            ...
            user_service.insert().values((5, "some name"))
         ...
         The above form would render a multiple VALUES statement similar to::
                ...
                INSERT INTO user_service (name) VALUES
                                (:name_1),
                                (:name_2),
                                (:name_3)
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        E.g.::
            ...
            stmt = update(user_service).where(user_service.c.id==5).\
                    values(name='user #5')
        ...
        :class:`.Table`::
            ...
            stmt = user_service.update().\
                        where(user_service.c.id==5).\
                        values(name='user #5')
        ...
        :param whereclause: Optional SQL expression describing the ``WHERE``
         ...
         subquery::
            ...
            user_service.update().values(name='ed').where(
                    user_service.c.name==select([addresses.c.email_address]).\
                                where(addresses.c.user_id==user_service.c.id).\
                                as_scalar()
                    )
