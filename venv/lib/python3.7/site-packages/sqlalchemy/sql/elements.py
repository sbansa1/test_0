...
class TextClause(Executable, ClauseElement):
    ...
    E.g.::
        ...
        t = text("SELECT * FROM user_service")
    ...
    def _create_text(
        ...
        E.g.::
            ...
            t = text("SELECT * FROM user_service WHERE id=:user_id")
            result = connection.execute(t, user_id=12)

        For SQL statements where a colon is required verbatim, as within
        an inline string, use a backslash to escape::

            t = text("SELECT * FROM user_service WHERE name='\:username'")
        ...
        such as for the WHERE clause of a SELECT statement::
            ...
            s = select([user_service.c.id, user_service.c.name]).where(text("id=:user_id"))
    ...
    def columns(self, selectable, *cols, **types):
        ...
        name or origin of the column in the textual SQL doesn't matter::
            ...
            stmt = text("SELECT user_service.id, addresses.id, user_service.id, "
                 "user_service.name, addresses.email_address AS email "
                 "FROM user_service JOIN addresses ON user_service.id=addresses.user_id "
                 "WHERE user_service.id = 1").columns(
                    User.id,
                    Address.id,
                    Address.user_id,
                    User.name,
