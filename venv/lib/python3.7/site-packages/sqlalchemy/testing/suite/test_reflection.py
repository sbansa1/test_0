...
class ComponentReflectionTest(fixtures.TablesTest):
    ...
    def define_views(cls, metadata, schema):
        for table_name in ("user_service", "email_addresses"):
            fullname = table_name
            if schema:
    ...
    def _test_get_table_names(
        ...
        if table_type == "view":
            ...
            if order_by == "foreign_key":
                answer = ["user_service", "email_addresses", "dingalings"]
                eq_(table_names, answer)
            else:
                answer = ["dingalings", "email_addresses", "user_service"]
                eq_(sorted(table_names), answer)
    ...
    def _test_get_comments(self, schema=None):
        ...
        eq_(insp.get_table_comment("user_service", schema=schema), {"text": None})
    ...
    def _test_get_columns(self, schema=None, table_type="table"):
        ...
        table_names = ["user_service", "email_addresses"]
        if table_type == "view":
    ...
    def _test_get_indexes(self, schema=None):
        ...
        insp = inspect(meta.bind)
        indexes = insp.get_indexes("user_service", schema=schema)
        expected_indexes = [
            {
                "unique": False,
    ...
    def test_get_table_oid(self):
        self._test_get_table_oid("user_service")

    @testing.requires.schemas
    def test_get_table_oid_with_schema(self):
        self._test_get_table_oid("user_service", schema=testing.config.test_schema)
