...
class Query(object):
    ...
    def _set_entities(self, entities, entity_wrapper=None):
        ...
        # 4. can't do "if entities" because user_service make use of undocumented
    ...
    def with_for_update(
        ...
        The above query on a PostgreSQL backend will render like::
            ...
            SELECT user_service.id AS users_id FROM user_service FOR UPDATE OF user_service NOWAIT
    ...
    def slice(self, start, stop):
        ...
        .. sourcecode:: sql
           ...
           SELECT user_service.id AS users_id,
                  user_service.name AS users_name
           FROM user_service ORDER BY user_service.id
           LIMIT ? OFFSET ?
           (2, 1)
    ...
    def prefix_with(self, *prefixes):
        ...
        Would render::
            ...
            user_service.name AS users_name FROM user_service
    ...
    def instances(self, cursor, __context=None):
        ...
        e.g.::
            ...
            result = engine.execute("select * from user_service")
    ...
    def exists(self):
        ...
        Producing SQL similar to::
            ...
            SELECT EXISTS (
                SELECT 1 FROM user_service WHERE user_service.name = :name_1
            ) AS anon_1
...
class AliasOption(interfaces.MapperOption):
    def __init__(self, alias):
        ...
        statement that aliases the parent table.  E.g.::
            ...
            ulist = user_service.select(user_service.c.user_id==7).\
                            union(user_service.select(user_service.c.user_id>7)).\
                            alias('ulist')
