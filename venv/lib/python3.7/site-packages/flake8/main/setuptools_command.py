...
class Flake8(setuptools.Command):
    ...
    # NOTE(sigmavirus24): If we populated this with a list of tuples, user_service
    ...
    # of options, and since this will break when user_service use plugins that
    # provide command-line options, we are leaving this empty. If user_service want
